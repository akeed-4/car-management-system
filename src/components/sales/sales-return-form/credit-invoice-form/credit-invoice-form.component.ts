...
import { ReturnInvoiceItem } from '@/src/models/return-invoice-item.model';
import { SalesInvoice } from '@/src/models/sales-invoice.model';
import { SalesReturn } from '@/src/models/sales-return.model';
...
@Component({
  selector: 'app-credit-invoice-form',
  standalone: true,
  ...
  templateUrl: './credit-invoice-form.component.html',
  styleUrl: './credit-invoice-form.component.css'
})
export class CreditInvoiceFormComponent {
