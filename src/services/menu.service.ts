...
export const menuData = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { id: 601, name: 'إنشاء طلب أسعار', englishName: 'New RFQ', route: '/purchases/requests/new' },
      ...
      { id: 605, name: 'إنشاء أمر شراء', englishName: 'New Purchase Order', route: '/purchases/orders/new' },
      { id: 62, name: 'استلام السيارات', englishName: 'Car Receipts', route: '/purchases/receipts' },
      { id: 603, name: 'استلام سيارات جديد', englishName: 'New Vehicle Receipt (GRN)', route: '/purchases/receipts/new' },
