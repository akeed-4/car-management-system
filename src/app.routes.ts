...
export const APP_ROUTES: Routes = [
  ...
  { path: 'sales/return/cash/:id/edit', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.cash.view')] },
  { path: 'sales/return/credit/:id/edit', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.credit.view')] },
  { path: 'sales/return/:id/edit', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.credit.view')] },
  { path: 'sales/cash/return/new', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.cash.view')] },
  { path: 'sales/cash/return/new/:id', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.cash.view')] },
  { path: 'sales/credit/return/new', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.credit.view')] },
  { path: 'sales/credit/return/new/:id', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.credit.view')] },
  { path: 'sales/return/cash/new', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.cash.view')] },
  { path: 'sales/return/credit/new', component: SalesReturnFormComponent, canActivate: [permissionGuard('sales.returns.credit.view')] },
  ...
  { path: 'sales/returns-approval', component: ManagerApprovalComponent, canActivate: [permissionGuard('sales.returns.approve.view')] },
